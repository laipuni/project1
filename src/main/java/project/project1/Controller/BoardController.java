...
import project.project1.service.*;
...
public class BoardController {
    ...
    public String boardsList(Model model,
        ...
        int startPage = getStartPage(condition.getPage(),10);
        int endPage = getEndPage(startPage,boardDto.getTotalPages());

        boolean isAdmin = securityMember.getAuthorities().contains(new SimpleGrantedAuthority("ROLE_Admin"));
    ...
    public String boardDetail(Model model,
        ...
        int startPage = getStartPage(pageable.getPageNumber() + 1,10);
        int endPage = getEndPage(startPage,findReplies.getTotalPages());
...
//    private boolean hasAuthority(MemberRole role, String userName){
//        return role
//    }

    private int getStartPage(int currentPage,int parsePage){
